                ...
                <tr>
                  <td style="padding:40px;">
                    ...
                    <p style="color:#6b7280;line-height:1.6;margin:0 0 24px;">
                      ...
                      We received a request to reset the password for your BuyLock account
                      (<strong>${data.userEmail}</strong>). Click the button below to set a new password.
                      This link expires in <strong>1 hour</strong>.
                    </p>
                    <div style="text-align:center;margin:32px 0;">
                      <a href="${data.resetUrl}" style="background:#FF4605;color:#ffffff;text-decoration:none;padding:14px 32px;border-radius:8px;font-weight:600;font-size:16px;display:inline-block;">
                        Reset Password
                      </a>
                    </div>
                    <p style="color:#9ca3af;font-size:13px;line-height:1.6;margin:24px 0 0;">
                      ...
                      <a href="${data.resetUrl}" style="color:#FF4605;word-break:break-all;">${data.resetUrl}</a>
                    </p>
                  </td>
                </tr>
                <tr>
                  <td style="background:#f9fafb;padding:20px 40px;text-align:center;border-top:1px solid #e5e7eb;">
                    <p style="margin:0;color:#9ca3af;font-size:12px;">© ${new Date().getFullYear()} BuyLock. All rights reserved.</p>
                  </td>
                </tr>
              </table>
            </td></tr>
...
export async function sendVendorPasswordResetEmail(data: {
  vendorEmail: string;
  vendorName: string;
  resetUrl: string;
}): Promise<boolean> {
  try {
              ...
              <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 6px rgba(0,0,0,0.07);">
                ...
                <tr>
                  <td style="padding:40px;">
                    <h2 style="margin:0 0 16px;color:#1f2937;font-size:20px;">Password Reset Request</h2>
                    <p style="color:#6b7280;line-height:1.6;margin:0 0 24px;">
                      Hi <strong>${data.vendorName}</strong>,<br><br>
                      We received a request to reset the password for your BuyLock Vendor account
                      (<strong>${data.vendorEmail}</strong>). Click the button below to set a new password.
                      This link expires in <strong>1 hour</strong>.
                    </p>
                    <div style="text-align:center;margin:32px 0;">
                      <a href="${data.resetUrl}" style="background:#FF4605;color:#ffffff;text-decoration:none;padding:14px 32px;border-radius:8px;font-weight:600;font-size:16px;display:inline-block;">
    ...
    console.log(`Password reset email sent to ${data.vendorEmail}`);
    return true;
  } catch (error) {
